...
//  source: /Users/Salton/Documents/Projects/GuerrillaMail/src/main/java/in/kyle/mail/Mailbox.java
//
...
- (OrgJsonJSONObject *)sendRequestWithNSString:(NSString *)url;
...
__attribute__((unused)) static OrgJsonJSONObject *InKyleMailMailbox_sendRequestWithNSString_(InKyleMailMailbox *self, NSString *url);
...
- (NSString *)initEmailAddress {
  @try {
    ...
    OrgJsonJSONObject *jsonObject = InKyleMailMailbox_sendRequestWithNSString_(self, url);
    return [((OrgJsonJSONObject *) nil_chk(jsonObject)) getStringWithNSString:@"email_addr"];
  }
...
- (void)checkMail {
  @try {
    ...
    OrgJsonJSONObject *jsonObject = InKyleMailMailbox_sendRequestWithNSString_(self, url);
    OrgJsonJSONArray *list = [((OrgJsonJSONObject *) nil_chk(jsonObject)) getJSONArrayWithNSString:@"list"];
    if (firstCheck_) {
      firstCheck_ = false;
    }
    else {
      for (jint i = 0; i < [((OrgJsonJSONArray *) nil_chk(list)) length]; i++) {
        OrgJsonJSONObject *email = [list getJSONObjectWithInt:i];
        jint id_ = [((OrgJsonJSONObject *) nil_chk(email)) getIntWithNSString:@"mail_id"];
        NSString *from = [email getStringWithNSString:@"mail_from"];
        NSString *subject = [email getStringWithNSString:@"mail_subject"];
        NSString *content = [email getStringWithNSString:@"mail_excerpt"];
...
- (NSString *)setEmailAddressWithNSString:(NSString *)user {
  @try {
    ...
    OrgJsonJSONObject *jsonObject = InKyleMailMailbox_sendRequestWithNSString_(self, url);
    JreStrongAssign(&emailAddress_, [((OrgJsonJSONObject *) nil_chk(jsonObject)) getStringWithNSString:@"email_addr"]);
    return emailAddress_;
  }
  @catch (OrgJsonJSONException *e) {
    @throw create_JavaIoIOException_initWithJavaLangThrowable_(e);
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOrgJsonJSONObject;", 0x2, 8, 7, 1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "JLJavaUtilConcurrentTimeUnit;", "LJavaIoIOException;", "setEmailListener", "LInKyleMailEmailListener;", "main", "[LNSString;", "setEmailAddress", "LNSString;", "sendRequest", "function", &InKyleMailMailbox_url };
  static const J2ObjcClassInfo _InKyleMailMailbox = { "Mailbox", "in.kyle.mail", ptrTable, methods, fields, 7, 0x1, 11, 6, -1, -1, -1, -1, -1 };
...
OrgJsonJSONObject *InKyleMailMailbox_sendRequestWithNSString_(InKyleMailMailbox *self, NSString *url) {
  ...
  @try {
    return create_OrgJsonJSONObject_initWithNSString_([response description]);
  }
  @catch (OrgJsonJSONException *e) {
    @throw create_JavaIoIOException_initWithJavaLangThrowable_(e);
  }
